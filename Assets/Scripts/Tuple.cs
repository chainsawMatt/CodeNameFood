...
public class Tuple<T1, T2>
{
    ...
    private static readonly IEqualityComparer Item1Comparer = EqualityComparer<Ticket>.Default;
    private static readonly IEqualityComparer Item2Comparer = EqualityComparer<Ticket>.Default;
